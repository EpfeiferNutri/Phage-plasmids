...
N_genomes =  read_excel( "Study_associated_data/Supplementary_data/S1_All_MGE_information_table.xlsx") %>% 
...
N_signature_genes = read_excel("Study_associated_data/Supplementary_data/T1_Cutoffs_information_table.xlsx")%>% 
...
Ratio_signature_to_all_0321 =  read_excel( "Study_associated_data/Supplementary_data/S1_All_MGE_information_table.xlsx") %>% 
  filter(`MGE type MM-GRC` %in% c("N15 group", "AB_1 subgroup", "cp32 group", 
                                      "P1_1 subgroup", "P1_2 subgroup", 
                                      "pKpn group", "pSLy3 group", "pCAV group", "pMT1 group", "SSU5_pHCM2 group") & `in 03/21` == "Yes") %>%
  mutate(`P-P type` = str_remove(`MGE type MM-GRC`, " (group|subgroup)$")) %>%
...
Profile_information = read_excel("Study_associated_data/Supplementary_data/S2_Profile_information_table.xlsx")
...
Profile_information_table = read_excel("Study_associated_data/Supplementary_data/S2_Profile_information_table.xlsx")
