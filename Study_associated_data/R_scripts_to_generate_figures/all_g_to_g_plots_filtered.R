...
genomes = fread("Study_associated_data/Supplementary_data/g2g_plot_tables/genomes_used_gggenomes.tsv")

# Protein information necessary for gggenomes plots (coordinates, protein IDs, etc.)
protein_info = fread("Study_associated_data/Supplementary_data/g2g_plot_tables/protein_info_used_gggenomes.tsv")

# Best Bi-directional Hit (BBH) protein-protein links
# Note: seq_id == query, seq_id2 == subject
BBH_links = fread("Study_associated_data/Supplementary_data/g2g_plot_tables/BBH_links_used_gggenomes.tsv")

# Table with wGRR (weighted Gene Repertoire Relatedness) values for selected genomes 
wGRR_info = fread("/Study_associated_data/Supplementary_data/g2g_plot_tables/wGRR_info_used_gggenomes.tsv")
