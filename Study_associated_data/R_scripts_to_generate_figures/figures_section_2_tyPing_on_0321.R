...
FINAL_PREDICTION_ = fread("Study_associated_data/Supplementary_data/S3B_Final_prediction_table_0321_by_tyPPing.tsv") 

# not used
# FINAL_SUMMARY = fread("Study_associated_data/Supplementary_data/S3A_All_hmm_hits_table_0321_by_tyPPing.tsv")
