...
Cutoffs_information = read_excel("Study_associated_data/Supplementary_data/T1_Cutoffs_information_table.xlsx")

FINAL_PREDICTION_ = fread("Study_associated_data/Supplementary_data/S4B_Final_prediction_table_0523_by_tyPPing.tsv")
# not used
# FINAL_SUMMARY = fread("Study_associated_data/Supplementary_data/S4A_All_hmm_hits_table_0523_by_tyPPing.tsv")
...
FINAL_PREDICTION_0321 = fread("Study_associated_data/Supplementary_data/S3B_Final_prediction_table_0321_by_tyPPing.tsv") %>%
